...
export default function ExtensionSimulator() {
  ...
  const [activeExtensionSection, setActiveExtensionSection] = useState<"fill" | "my-data">("fill");
      ...
      <div className="flex-grow xl:w-2/3 bg-[#0d0e14] border border-[#20253f] rounded-2xl overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="bg-[#161a2f]/60 px-5 py-3 border-b border-[#20253f]/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-2">
            <span className="text-xs text-slate-400 font-display">Текущая открытая вакансия на странице:</span>
            <select
              value={selectedJobId}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-[#20253f] flex-grow overflow-y-auto">
          ...
          <div className="p-6 space-y-4 bg-[#090b14]/40">
            ...
            <div className="p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/15 flex gap-2.5 items-start">
              <Sparkles size={16} className="text-emerald-400 flex-shrink-0 mt-0.5 animate-pulse" />
              <p className="text-[11px] text-slate-400 leading-normal">
                Команда JobFill считывает данные из этого левого блока напрямую. Кликните на <strong className="text-emerald-300">"Считать DOM & Адаптировать"</strong> в правой панели, чтобы сымитировать считывание HTML-контента!
              </p>
            </div>
          </div>
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                    showFormHighlight && webFormFields.fullName ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                  }`}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.email ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                  }`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.phone ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                    }`}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                    showFormHighlight && webFormFields.skills ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                  }`}
                />
              </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-2.5 py-1.5 bg-[#06070d] border rounded text-xs text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.githubUrl ? "border-emerald-500 text-emerald-300" : "border-[#21274d]"
                    }`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    placeholder="https://..."
                    className={`w-full px-2.5 py-1.5 bg-[#06070d] border rounded text-xs text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.portfolioUrl ? "border-emerald-500 text-emerald-300" : "border-[#21274d]"
                    }`}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="300 000 руб."
                    className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.expectedSalary ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                    }`}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all ${
                      showFormHighlight && webFormFields.customNotice ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                    }`}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 text-xs font-sans transition-all resize-none ${
                    showFormHighlight && webFormFields.achievements ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5 font-mono text-[11px]" : "border-[#1e2448] focus:border-indigo-500"
                  }`}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-3 py-2 bg-[#0d0f1b] border rounded-lg text-slate-200 transition-all resize-none ${
                    showFormHighlight && webFormFields.coverLetter ? "border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.2)] bg-emerald-500/5" : "border-[#1e2448] focus:border-indigo-500"
                  }`}
                />
              </div>
        ...
        <div className="bg-[#0b0d19] px-4 py-3 border-b border-[#232849] flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-indigo-500/10 border border-indigo-500/30 flex items-center justify-center">
              <Puzzle size={16} className="text-indigo-400 glow-animation animate-pulse" />
            </div>
            <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#0c0d15] rounded-xl border border-indigo-500/20 p-3 text-center space-y-2.5">
                ...
                >
                  ...
                  {isScanning ? "Считывание DOM..." : "Считать DOM & Адаптировать"}
                </button>
              ...
              {scannedResume ? (
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3 space-y-2">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-0.5">
                        <span className="text-[9px] text-[#8e95b3] font-semibold">Сопроводительное сообщение:</span>
                        <button
                          onClick={() => copyText(scannedResume.coverLetter, "cov-ext")}
                          className="text-[9px] text-emerald-300 hover:text-emerald-100 flex items-center gap-0.5 font-bold"
                        >
                          {copiedField === "cov-ext" ? "Скопировано!" : "Копировать"}
                        </button>
                      </div>
                ...
                <div className="bg-[#0c0d15]/50 border border-[#232849]/50 rounded-xl p-4 text-center text-slate-500 text-[11px] space-y-1">
                  <Wand2 size={24} className="mx-auto text-slate-700 animate-pulse" />
                  <p className="font-semibold text-slate-400">Резюме еще не адаптировано</p>
                  <p className="text-[10px] text-slate-500 leading-normal">
                    Нажмите <strong className="text-indigo-400">"Считать DOM & Адаптировать"</strong> выше. Расширение прочитает требования и подготовит файлы.
                  </p>
                </div>
              )}
              ...
              <div className="bg-[#0b0c15]/80 rounded-xl p-3 border border-[#232849] space-y-2">
                ...
                <div className="text-[11px] text-slate-300 space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-emerald-400 font-mono truncate max-w-[150px]">{profile.title}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">Контакты:</span>
                    <span className="text-indigo-300 font-mono truncate max-w-[150px]">{profile.email}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#0c0d15] p-3 rounded-xl border border-[#21274c] space-y-2">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-0.5">Читабельное название поля</label>
                    <input
                      type="text"
                      value={newFieldLabel}
                  ...
                  <div>
                    <label className="text-[10px] text-slate-500 block mb-0.5">Значение поля</label>
                    <input
                      type="text"
                      value={newFieldValue}
